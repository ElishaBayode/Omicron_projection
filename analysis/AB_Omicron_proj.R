...
make_init = function( N=4.37e6, vaxlevel = 0.75,
                      port_wane = 0.1, 
                      past_infection = 0.1, incres = 430, incmut = 10, 
...
dat = readRDS("/Users/elishaare/Desktop/PHAC_forecasts_28DEC2021/COVID-PHAC-forecasts/data-generated/AB-dat.rds")
