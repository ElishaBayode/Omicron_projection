...
# requires covidseir fits. and probably the covidseir library etc 

fit = readRDS("data/BC-fit.rds")
...
incid =readRDS(file.path("data/BC-incid.rds"))

saveRDS(incid_sd_BC, file.path("data/BC-incid_er.rds"))
incid_sd_BC =readRDS(file.path("data/BC-incid_er.rds"))


saveRDS(incid_int, file.path("data/BC-incid_int.rds"))
incid_int =readRDS(file.path("data/BC-incid_int.rds"))

saveRDS(incid_sd_BC_int, file.path("data/BC-incid_er_int.rds"))
