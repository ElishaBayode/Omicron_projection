...
parameters <-         c(sigma=1/3, # incubation period (3 days) (to fixed)
                        ...
                        beta_m=0.52*1.7, #transmission rate (to estimate)(*1.9)
...
intro_date <- ymd("2021-12-28")
incid = get_total_incidence(output=output_MB,parameters) #set output to Province output 
